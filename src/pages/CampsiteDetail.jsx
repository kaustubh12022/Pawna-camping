                        ...
                        {packages.map((pkg, idx) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-[var(--listing-accent)] text-white rounded-xl text-sm font-bold tracking-wide hover:opacity-90 transition-opacity active:scale-[0.98] mt-auto"
                                >
                                    BOOK NOW
                                </button>
